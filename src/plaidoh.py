...
from preprocessors.classical_preprocessor import (
    ClassicalPreprocessor,
)

from optimizers.classical_optimizer import (
    ClassicalOptimizer,
)
...
class Plaidoh:
    ...
    """
    score : scores the models based on the model metrics. If the metrics given in the list are not
    ...
    """
    train : trains the models on the training data.
    ...
    """
    predict : predicts the target values for the testing data.
    ...
    """
    optimize : optimizes the models based using random search. This is called during the Plaidoh
    ...
    """
    visualize : visualizes the models using the given visualizations. If no visualizations are
    ...
    """
    export_models : exports the models to the given path.
